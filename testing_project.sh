...
# check `testing_result` directory exists.
...
# check `testing_result/$test_project_name` directory exists.
...
# check `testing_result/$test_project_name/$test_data` directory exists
...
# check `testing_result/$test_project_name/$test_data/$test_device_serial_number` directory exists
